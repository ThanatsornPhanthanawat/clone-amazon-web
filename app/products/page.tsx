...
export default function Products() {
  ...
  return (
    <div className="w-full ">
      <div className="px-[11px] py-[6px] flex flex-col shadow-sm shadow-gray-400 sm:flex-row sm:justify-between sm:items-center w-full   text-xs">
        <div className="flex flex-wrap sm:flex-nowrap ml-[13px] gap-x-4">
          <div className=" flex justify-center items-center  font-semibold cursor-pointer border-b-3 border-transparent hover:text-[#2162a1] hover:border-[#2162a1] transition">
            Today's Deals
          </div>
